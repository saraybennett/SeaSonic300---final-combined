...
- cursor data being sent to the server and then broadcast to the client, now the only issue is that the cursor is not being drawn on the screen, lines 287-292 in app.js, reached out to brian for help:
